...
| **github.com/redis/redis/v9** | v9.x | **Current: v9.20.1 (Jun 2026)** |
...
- **go-redis v9.20.1** — released 2026-06-11, latest stable
...
- **Go 1.27** — in release freeze (20 days in as of Jun 9), no RC1 yet
