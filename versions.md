...
The Go 1.27 release freeze began **May 20, 2026** — 9 days in as of May 29, no RC1 yet. Monitor the [Go release dashboard](https://dev.golang.org/release) for tag announcements. RC1 expected within the next week. The draft release notes page exists at [go.dev/doc/go1.27](https://go.dev/doc/go1.27) but is not finalized until release.
...
- Go 1.27 release freeze began May 20, 2026 — 9 days in as of May 29, no RC1 yet ([golang/go#76474](https://github.com/golang/go/issues/76474))
